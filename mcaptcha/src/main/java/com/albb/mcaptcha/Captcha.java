...
public class Captcha extends LinearLayout {
    ...
    private int refDrawableId;       //刷新按钮图片背景
    private int refHeight;       //刷新按钮高度
    private int refWidth;       //刷新按钮宽度
    private int refMarginLeft;       //刷新按钮左边距
    private int refMarginRight;       //刷新按钮右边距
    private int refMarginTop;       //刷新按钮上边距
    private int refMarginBottom;       //刷新按钮低边距
    ...
    public Captcha(@NonNull final Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        progressDrawableId = typedArray.getResourceId(R.styleable.Captcha_progressDrawable, R.mipmap.seekbar_bar);
        thumbDrawableId = typedArray.getResourceId(R.styleable.Captcha_thumbDrawable, R.mipmap.seekbar_thume);
        ...
        blockSize = typedArray.getDimensionPixelSize(R.styleable.Captcha_blockSize, Utils.dp2px(getContext(), 85));
        refDrawableId = typedArray.getResourceId(R.styleable.Captcha_refreshDrawable, R.mipmap.refresh);
        refHeight = typedArray.getDimensionPixelSize(R.styleable.Captcha_refreshHeight, Utils.dp2px(getContext(), 21));
        refWidth = typedArray.getDimensionPixelSize(R.styleable.Captcha_refreshWidth, Utils.dp2px(getContext(), 18));
        refMarginLeft = typedArray.getDimensionPixelSize(R.styleable.Captcha_refMarginLeft, Utils.dp2px(getContext(), 5));
        refMarginRight = typedArray.getDimensionPixelSize(R.styleable.Captcha_refMarginRigth, Utils.dp2px(getContext(), 5));
        refMarginTop = typedArray.getDimensionPixelSize(R.styleable.Captcha_refMarginTop, Utils.dp2px(getContext(), 5));
        refMarginBottom = typedArray.getDimensionPixelSize(R.styleable.Captcha_refMarginBottom, Utils.dp2px(getContext(), 5));
        typedArray.recycle();
        init();
    }
    ...
    private void init() {
        ...
        if (refDrawableId != -1) {
            refreshView.setImageResource(refDrawableId);
        }
    ...
    public void setRefreshAttrs() {
        ViewGroup.LayoutParams  params = refreshView.getLayoutParams();
        params.height = refHeight;
        params.width = refWidth;
        ...
        layoutParams.setMargins(refMarginLeft,refMarginTop,refMarginRight,refMarginBottom);
